...
const (
	...
	REQUEST_TYPE_ORDER_CANCEL         = "1004" // 预约取件取消API
	...
	REQUEST_TYPE_EXPRESS_SEARCH       = "8002" // 快递查询API
	REQUEST_TYPE_INT_FOLLOW_SUBSCRIBE = "7008" // 快递查询API（国际版）
	REQUEST_TYPE_MAP_MONITOR_REALTIME = "8003" // 即时查询API（地图版）
	REQUEST_TYPE_MAP_FOLLOW_SUBSCRIBE = "8005" // 轨迹订阅API（地图版）
